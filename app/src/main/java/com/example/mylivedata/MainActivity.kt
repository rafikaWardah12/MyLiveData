...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //Menghubungkan MainViewModel dengan MainActivity. Penghubungnya = getElapsedTime pada MainViewModel
        //Memanggil = subscribe sehingga saat perubahan data otomatis mengubah textView
        subscribe()
    }
